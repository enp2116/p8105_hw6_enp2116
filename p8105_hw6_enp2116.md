...
distribution is also somewhat skewed\*\*\*\*\* (outliers with a \*\*\*\*
...
exception of mrace3). The final adjusted $R^2$ was 0.6222, which did not
improve with taking out additional variables.
